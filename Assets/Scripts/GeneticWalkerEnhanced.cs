...
public class GeneticWalkerEnhanced : MonoBehaviour
{
    ...
    private List<WalkerCreatureEnhanced> population = new List<WalkerCreatureEnhanced>();
...
private float bodyMass;
    ...
    void GenerateInitialPopulation()
    {
        ...
        bodyMass = Random.Range(3f, 5f); // default was: 4f;
            ...
            //var creature = new WalkerCreatureEnhanced(new Vector3(i * 10f, 2, 0), genome);
            var creature = new WalkerCreatureEnhanced(new Vector3((i % 5) * 10f, 2, (i / 5) * 10f), genome);
    ...
    void EvolvePopulation()
    {
        ...
        for (int i = 0; i < populationSize; i++)
        {
            //var creature = new WalkerCreatureEnhanced(new Vector3(i * 3f, 2, 0), genomes[i]);
            var creature = new WalkerCreatureEnhanced(new Vector3((i % 5) * 10f, 2, (i / 5) * 10f), genomes[i]);
            population.Add(creature);
        }
    ...
    void ColorFastestCreature(WalkerCreatureEnhanced creature)
    {
...
void IgnoreCollisionsBetweenCreatures(WalkerCreatureEnhanced a, WalkerCreatureEnhanced b)
{
